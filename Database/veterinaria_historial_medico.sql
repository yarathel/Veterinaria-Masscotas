...
CREATE TABLE `historial_medico` (
  ...
  CONSTRAINT `historial_medico_ibfk_1` FOREIGN KEY (`id_veterinario`) REFERENCES `veterinario` (`id_veterinario`),
  CONSTRAINT `historial_medico_ibfk_2` FOREIGN KEY (`id_mascota`) REFERENCES `mascota` (`id_mascota`)
